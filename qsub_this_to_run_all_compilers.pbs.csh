...
if ( ! -e Data/v04.04  ) then
   echo "ERROR ERROR ERROR"
   echo ""
   echo "'Data' directory is not the correct version (v04.04)"
   echo "If on Cheyenne, link /glade/p/wrf/Data into your WTF directory"
   echo ""
   echo "Otherwise, it can be downloaded from http://www2.mmm.ucar.edu/wrf/tmp/data_v04.04.tar"
   exit 2
endif
